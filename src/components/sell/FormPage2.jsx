...
function FormPage2({ handleFormChange, formData }) {
  ...
  return (
    <div className=" mx-auto p-5 sm:p-10 pt-12 bg-white border border-gray-300 shadow">
      ...
      <div className="grid grid-cols-4 space-y-5 mt-12 p-5 sm:p-10 pt-4 border bg-white border-gray-300 rounded overflow-hidden shadow">
        ...
        <div className="space-y-3 col-span-4 md:col-span-2 md:mr-5">
        ...
        <div className="space-y-3 col-span-4 md:col-span-2 md:mr-5">
          <label className="block text-sm font-semibold" htmlFor="buildYear">
            Year built
          </label>
          <select
            value={formData.buildYear}
            onChange={(e) => handleFormChange(e)}
            className="w-full h-10 px-3 bg-gray-50 rounded-lg border border-gray-300 outline-none"
            id="buildYear"
          >
            <option></option>
            {years.map((year) => (
        ...
        <div className="space-y-3 col-span-4 md:col-span-2 md:mr-5">
          <label className="block text-sm font-semibold" htmlFor="remodelYear">
            Year rennovated
          </label>
          <select
